...
/**
 * Number or integer data type for the schema.
 *
 * @author Mat Lipe
 * @since  5.2.0
 *
 ...
 */
class NumberType implements TypeRules, ArgsRules {
	/**
	 ...
	 * @var string
	 */
	public string $type = Resource_Schema::TYPE_NUMBER;
	 ...
	 *
	 * @param float|int $minimum - The minimum value the value must be greater than or equal to.
	 *
	 * @return static
	 */
	 ...
	 *
	 * @param float|int $maximum - The maximum value the value must be less than or equal to.
	 *
	 * @return static
	 */

...
class Post_Type {
	 ...
	 *
	 * @see Post_Type::add_support()
	 * @see Post_Type::remove_support()
	 *
	 * @phpstan-var list<Register_Post_Type::SUPPORTS_*>
	 */
	public const array DEFAULT_SUPPORTS = [
	...
	protected const string REGISTRY_OPTION    = 'lipe/lib/post-type/custom-post-type/registry';
	protected const string CUSTOM_CAPS_OPTION = 'lipe/lib/post-type/custom-post-type/caps';
	 ...
	 * properties are set.
	 *
	 * @see Post_Type::get_post_type_args()
	 *

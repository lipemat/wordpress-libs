...
class Labels {
	...
	public const string ARCHIVE_LABEL            = 'archive_label';
	public const string EDIT_ITEM                = 'edit_item';
	public const string NEW_ITEM                 = 'new_item';
	...
	public const string NOT_FOUND_IN_TRASH       = 'not_found_in_trash';
	...
	public const string INSERT_INTO_ITEM         = 'insert_into_item';
	public const string UPLOADED_TO_THIS_ITEM    = 'uploaded_to_this_item';
	public const string FEATURED_IMAGE           = 'featured_image';
	public const string SET_FEATURED_IMAGE       = 'set_featured_image';
	public const string REMOVE_FEATURED_IMAGE    = 'remove_featured_image';
	public const string USE_FEATURED_IMAGE       = 'use_featured_image';
	public const string MENU_NAME                = 'menu_name';
	public const string FILTER_ITEMS_LIST        = 'filter_items_list';
	public const string ITEMS_LIST_NAVIGATION    = 'items_list_navigation';
	public const string ITEMS_LIST               = 'items_list';
	public const string ITEM_PUBLISHED           = 'item_published';
	public const string ITEM_PUBLISHED_PRIVATELY = 'item_published_privately';
	public const string ITEM_REVERTED_TO_DRAFT   = 'item_reverted_to_draft';
	public const string ITEM_SCHEDULED           = 'item_scheduled';
	...
	public const string FILTER_BY_DATE           = 'filter_by_date';

...
class Register_Post_Type implements ArgsRules {
	...
	public const string TEMPLATE_LOCK_ALL     = 'all';
	public const string TEMPLATE_LOCK_CONTENT = 'contentOnly';
	public const string TEMPLATE_LOCK_INSERT  = 'insert';
	public const bool   TEMPLATE_LOCK_FALSE   = false;

	public const string SUPPORTS_AUTHOR          = 'author';
	public const string SUPPORTS_AUTOSAVE        = 'autosave';
	public const string SUPPORTS_COMMENTS        = 'comments';
	public const string SUPPORTS_CUSTOM_FIELDS   = 'custom-fields';
	public const string SUPPORTS_EDITOR          = 'editor';
	public const array  SUPPORTS_EDITOR_NOTES    = [ 'editor' => [ 'notes' => true ] ];
	public const string SUPPORTS_EXCERPT         = 'excerpt';
	public const string SUPPORTS_PAGE_ATTRIBUTES = 'page-attributes';
	public const string SUPPORTS_POST_FORMATS    = 'post-formats';
	public const string SUPPORTS_REVISIONS       = 'revisions';
	public const string SUPPORTS_THUMBNAIL       = 'thumbnail';
	public const string SUPPORTS_TITLE           = 'title';
	public const string SUPPORTS_TRACKBACKS      = 'trackbacks';
